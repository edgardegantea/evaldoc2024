        ...
        <div class="">
            <form action="<?= base_url('/registro') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputBorderWidth2">Matrícula:</label>
                                <input type="text" class="form-control"
                                       id="exampleInputBorderWidth2" name="codigo" placeholder="202300000">
                            </div>
                        </div>
                    ...
                    <h3 class="mt-5">Datos para iniciar sesión</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="card-footer mt-3 text-center">
                    <button type="reset" class="btn btn-light">Restablecer campos</button>
