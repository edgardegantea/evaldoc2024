...
class EvaluacionController extends BaseController
{
    ...
    public function resultados()
    {
        ...
        $data['evaluaciones'] = $evaluacionModel->where('created_at >', '2024-03-10')->orderBy('profesor_id', 'asc')->findAll();
    ...
    {
        $profesorModel = new ProfesorModel();
        $data['professors'] = $profesorModel->where('profesores.estado =', 1)->findAll();
    ...
    public function comentariosProfesor($profesorId)
    {
        ...
        $comments = $evaluacionModel
            ...
            ->where('evaluacion.comentario !=', '')
            ->where('evaluacion.created_at >', '2024-03-10')
            ->findAll();
...
// Pass the professor's name, average scores, and averages to the view
        ...
        $comments = $evaluacionModel->select('comentario')->where('profesor_id', $profesorId)->where('comentario !=', '')->where('evaluacion.created_at > ', '2024-03-10')->findAll();
