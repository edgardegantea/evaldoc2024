...
class ResetPassword extends Controller
{
    ...
    public function sendResetLink()
    {
        ...
        $email->setFrom('ramdyosborn@yahoo.com', 'Soporte Técnico');
        $email->setTo($user['email']);

        $email->setSubject('Recuperación de Contraseña');
        $email->setMessage('Hola '. $user['nombre'] .':<br><br>Usted solicitó recuperar su contraseña para ingresar al Sistema de Evaluación Docente de UPN 212 Teziutlán. Haga clic en el siguiente enlace para restablecer su contraseña: <a href="' . $resetLink . '">Restablecer Contraseña</a><br><br>Si usted no solicitó el cambio entonces haga caso omiso y repórtelo al desarrollador del sistema por email a: edgar.degante.a@gmail.com o por WhatsApp al: 231 205 1120<br><br>Saludos.');
        ...
        if (!$email->send()) {
            ...
            return redirect()->back()->with('success', 'Se ha enviado un enlace de restablecimiento a su email.');
        }
